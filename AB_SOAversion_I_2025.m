function [] = AB_SOAversion_I_2025()
%% 本代码为无节律条件下，间隔线索的提示作用
...
expinfo.sequence = expinfo.seq;

% Set the folder and filename for data save
destdir = './SOA_I/posttest/';
...
%                 ISIseq(5:7) = 0;
%             elseif T2pos == 2
%                 ISIseq(5:6) = expinfo.stdura/2 -numstim;
            end
